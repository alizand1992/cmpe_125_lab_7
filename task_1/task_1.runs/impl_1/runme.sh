...
HD_PWD='C:/Users/Ali/Documents/cmpe_125_lab_7/task_1/task_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_7_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_7_fpga.tcl -notrace
