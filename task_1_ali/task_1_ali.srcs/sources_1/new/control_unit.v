module control_unit(
    ...
    assign { s1, wa, we, raa, rab, c, we, rea, reb, s2, done } = controls;
    ...
    begin
        case(cs)
            ...
            4'b0011:
                case(op)
                    2'b00: controls = 15'b11_11_01_10_00_1_1_1_0_0;
                    2'b01: controls = 15'b11_11_01_10_01_1_1_1_0_0;
                    2'b10: controls = 15'b11_11_01_10_10_1_1_1_0_0;
                    2'b11: controls = 15'b11_11_01_10_11_1_1_1_0_0;                    
                endcase
